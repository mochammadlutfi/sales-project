...
class KecamatanSelect extends GetView<WilayahController> {
  final bool enabled;
  final String? parentId;
  final KecamatanModel? selected;
  final Function(KecamatanModel) onSelect;
  final String? Function(KecamatanModel?)? onValidate;
  final String? filter;
    ...
    return Column(
      ...
      children: [
        ...
        DropdownSearch<KecamatanModel>(
          ...
          asyncItems: (String? filter) => controller.getKecamatan(parentId, filter),
  ...
  Widget _wrapperModal(BuildContext context, KecamatanModel item, bool isSelected) {
    return Container(
